...
import { Credentials } from 'OCI-sdk'
import * as tl from 'azure-pipelines-task-lib/task'
import { getRegion } from 'Common/OCIConnectionParameters'
...
export class TaskOperations {
    ...
    public async execute(): Promise<void> {
        ...
        if (this.credentials) {
            ...
            env.OCI_ACCESS_KEY_ID = this.credentials.accessKeyId
            env.OCI_SECRET_ACCESS_KEY = this.credentials.secretAccessKey
            if (this.credentials.sessionToken) {
                env.OCI_SESSION_TOKEN = this.credentials.sessionToken
            }
        }
