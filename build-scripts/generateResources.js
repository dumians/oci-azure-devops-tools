...
// Downloads the latest known OCI regions file used by the various
// OCI toolkits and constructs an object we can inject into each
...
function addOCIRegionsToTask(task, knownRegions) {
...
function generateTaskResources(taskPath, knownRegions, versionInfo) {
    ...
    addOCIRegionsToTask(task, knownRegions)
